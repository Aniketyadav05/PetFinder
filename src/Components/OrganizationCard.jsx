...
const OrganizationCard = ({image="../assets/fallback.jpg", name, address,num}) => {
  ...
  return (
   <div className={`${bgColor} rounded-2xl overflow-hidden shadow-lg transition-transform hover:scale-[1.02] duration-300`}>
      
      <div className={`rounded-xl max-w-xs mx-auto w-full flex flex-col items-center justify-center p-4 `}>
