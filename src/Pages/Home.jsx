...
const Home = () => {
  ...
  return (
    <div>
      <Hero/>
      <h1 className="text-[#442001] mt-2">Find your Match</h1>
      <div className="flex flex-row space-x-4 mx-8 my-4">
      ...
      <h1 className="text-[#442001] mt-2">Trusted Pet Organizations</h1>
      <div className="flex flex-row space-x-4 mx-8 my-4">
